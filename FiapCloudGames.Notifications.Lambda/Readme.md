...
Execute unit tests
```
    cd "FiapCloudGames.Notifications.Lambda/test/FiapCloudGames.Notifications.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "FiapCloudGames.Notifications.Lambda/src/FiapCloudGames.Notifications.Lambda"
